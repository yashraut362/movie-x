// Hardcoded world for the booking simulation. Which seats are taken comes
// from the backend (/api/bookings), everything else lives here.
...
// Today's date in the user's timezone as "YYYY-MM-DD". Shows are for today only.
